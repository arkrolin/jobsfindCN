...
一个基于 Claude Code 的 AI Skill 系统，聚焦于**提高中国求职者的就职能力**。不仅仅是投递管理，而是帮你真正提升——简历优化、算法刷题、八股文准备、模拟面试。
...
> **这不是海投工具。** jobsfindCN 的目标是帮你提升能力，让你在面试中脱颖而出。能力到了，offer 自然来。

## 和 career-ops 的关系

[career-ops](https://github.com/santifer/career-ops) 偏重**投递管道管理**（JD 评估、ATS CV 生成、投递追踪）。jobsfindCN 偏重**求职能力提升**（刷题、八股文、模拟面试）。两者可以配合使用——用 jobsfindCN 练好内功，用 career-ops 管好外功。
